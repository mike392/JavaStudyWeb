...
<nav class="navbar navbar-inverse bg-primary navbar-toggleable-md" style="background-color: #e3f2fd;">
		  ...
		  <div class="collapse navbar-collapse" id="navbarNavDropdown">
		    <ul class="navbar-nav">
		      ...
		      <li class="nav-item">
		        <a id="add-button" class="nav-link" href="${pageContext.request.contextPath}/controller?command=subscription_edit"><fmt:message key="subscriptionedit.button.add" bundle="${rb}"/></a>
		      </li>
		      <li class="nav-item">
