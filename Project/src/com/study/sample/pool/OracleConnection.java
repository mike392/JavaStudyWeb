...
public class OracleConnection implements Connection {
	private static Logger logger = LogManager.getLogger(OracleConnection.class);
	private Connection conn;
	OracleConnection(){
		try {
			Class.forName ("oracle.jdbc.driver.OracleDriver");
			this.conn = DriverManager.getConnection(DatabaseConfigManager.getProperty("db.url"), 
					DatabaseConfigManager.getProperty("dbuser.name"), 
					DatabaseConfigManager.getProperty("dbuser.password"));
		} catch (SQLException | ClassNotFoundException e) {
			logger.log(Level.FATAL, " Error when creating Oracle connection " + e.getLocalizedMessage());
			throw new RuntimeException(" Error when creating Oracle connection ", e);
		}
	}
